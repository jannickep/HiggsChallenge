...
def test_SdA(finetune_lr, pretraining_epochs,
    ...
    if (submit ==1):
        ...
        test_pred = theano.function((), sda.logLayer.y_pred, givens={sda.x: shared_test_x})
        test_prob = theano.function((), sda.logLayer.p_y_given_x, givens={sda.x: shared_test_x})
        ...
        np.savetxt("../data/submission.csv",submission,fmt='%s',delimiter=',')
