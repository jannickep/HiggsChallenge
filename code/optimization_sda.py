...
x[1] = Parameter("finetune_lr" , [1,0.1,0.01])
x[2] = Parameter("improvement_threshold" , [0.995])
x[3] = Parameter("neurons_per_layer" , [20,30,40,50])
x[4] = Parameter("number_of_layers" ,[1,2,3,4])
x[5] = Parameter("patience" , [1000,10000])
x[6] = Parameter("patience_increase" , [2])
x[7] = Parameter("pretraining_epochs" , [10])
x[8] = Parameter("pretrain_lr" , [0.001]) 
x[9]= Parameter("submit_threshold" , [0.5])
x[10] = Parameter("training_epochs" , [500, 1000])
                          ...
                          for p in range(len (x[7].values)):
                            for q in range(len (x[8].values)):
                              for r in range(len (x[9].values)):
                                for s in range(len (x[10].values)):
